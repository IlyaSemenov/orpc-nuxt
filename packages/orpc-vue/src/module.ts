...
export default defineNuxtModule<ModuleOptions>({
  ...
  setup(options, nuxt) {
    ...
    nuxt.options.build.transpile.push("orpc-vue")
    ...
    optimizeDeps.exclude.push("orpc-vue", "@tanstack/vue-query")
    const composables = resolver.resolve("./runtime/nuxt/runtime")
    addImports([
    ...
    if (options.queryClient) {
      ...
      addPluginTemplate({
        filename: "orpc-vue/query-client.mjs",
